...
def calDistanceBetweenPoints(points1, points2):
    ...
    if len(points1) % 2 == 0:
        ...
        medLat1 = (points1[(len(points1)/2) - 1]['gpsReading']['location']['coordinates'][0] + 
        ...
        medLon1 = (points1[(len(points1)/2) - 1]['gpsReading']['location']['coordinates'][1] + 
                points1[len(points1)/2]['gpsReading']['location']['coordinates'][1]) / 2    
    else:
        points1 = sorted(points1, key = lambda point: point['gpsReading']['location']['coordinates'][0])
        medLat1 = points1[(len(points1)/2)]['gpsReading']['location']['coordinates'][0]
        points1 = sorted(points1, key = lambda point: point['gpsReading']['location']['coordinates'][1])
        medLon1 = points1[(len(points1)/2)]['gpsReading']['location']['coordinates'][1]

    if len(points2) % 2 == 0:
        points2 = sorted(points2, key = lambda point: point['gpsReading']['location']['coordinates'][0])
        medLat2 = (points2[(len(points2)/2) - 1]['gpsReading']['location']['coordinates'][0] + 
        ...
        medLon2 = (points2[(len(points2)/2) - 1]['gpsReading']['location']['coordinates'][1] + 
                points2[len(points2)/2]['gpsReading']['location']['coordinates'][1]) / 2    
    else:
        points2 = sorted(points2, key = lambda point: point['gpsReading']['location']['coordinates'][0])
        medLat2 = points2[(len(points2)/2)]['gpsReading']['location']['coordinates'][0]
        points2 = sorted(points2, key = lambda point: point['gpsReading']['location']['coordinates'][1])
        medLon2 = points2[(len(points2)/2)]['gpsReading']['location']['coordinates'][1]
        
    point1 = [medLat1, medLon1]
    point2 = [medLat2, medLon2]    
