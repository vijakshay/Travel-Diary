...
# Method for generating logs for each of the system users for a given day

def generateLogs(testers, date, gmtConversion, groundTruthPath, rawDataPath):        

    gpsTraces, data = [], []
    for tester in testers:
        try:
            print 'Tester:', tester['name']
            print 'Phone Number:', tester['ph']
            ...
            print 'Status: Log generated successfully\n'
...
if __name__ == "__main__":
    ...
    date = '05012014'        # MMDDYYYY format of day for which you wish to extract data
    ...
    # Call to generate logs
    generateLogs(testers, date, gmtConversion, groundTruthPath, rawDataPath)